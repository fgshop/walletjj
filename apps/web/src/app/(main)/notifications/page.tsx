  ...
  if (loading) {
    return (
      <div className="pb-20 sm:pb-0">
        ...
        <p className="mb-6 text-sm text-text-secondary">새로운 알림을 확인하세요</p>
  ...
  return (
    <div className="pb-20 sm:pb-0">
      ...
      {notifications.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-2xl bg-surface py-16 text-text-secondary shadow-sm">
          ...
          {notifications.map((n) => (
            <button
              ...
              className={`flex w-full items-start gap-3 rounded-xl p-4 text-left transition ${
                n.isRead ? 'bg-surface' : 'bg-blue-50/50 hover:bg-blue-50'
              }`}
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-surface-dim text-lg">
                {typeIcons[n.type] || '📢'}
              </div>
