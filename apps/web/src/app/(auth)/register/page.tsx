    ...
    <div className="flex min-h-screen items-center justify-center bg-surface-dim px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-text-secondary">새 계정을 만드세요</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl bg-surface p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              <label className="mb-1.5 block text-sm font-medium text-text">이름</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="mb-1.5 block text-sm font-medium text-text">비밀번호 확인</label>
              <div className="relative">
                <input
